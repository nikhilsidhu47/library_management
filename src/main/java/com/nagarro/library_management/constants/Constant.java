...
public class Constant {
	public static final String HIBERNATE_USERNAME="nikhilroot";
	public static final String HIBERNATE_PASSWORD="Ritiva@taken";
	...
	public static final String HIBERNATE_URL="jdbc:mysql://assignment-server-nikhil.mysql.database.azure.com/:3306/library_login";
